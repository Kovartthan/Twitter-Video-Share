 ...
 */
/*package*/public final class UserJSONImpl extends TwitterResponseImpl implements User, java.io.Serializable {
    ...
    /*package*/public UserJSONImpl(HttpResponse res, Configuration conf) throws TwitterException {
        super(res);
