...
import com.ko.twitter.vplay.core.auth.AuthorizationFactory;
import com.ko.twitter.vplay.core.auth.BasicAuthorization;
import com.ko.twitter.vplay.core.auth.NullAuthorization;
import com.ko.twitter.vplay.core.auth.OAuth2Authorization;
import com.ko.twitter.vplay.core.auth.OAuth2Support;
import com.ko.twitter.vplay.core.auth.OAuth2Token;
import com.ko.twitter.vplay.core.auth.OAuthAuthorization;
...
import com.ko.twitter.vplay.core.internal.http.HttpClient;
import com.ko.twitter.vplay.core.internal.http.HttpClientFactory;
import com.ko.twitter.vplay.core.internal.http.HttpParameter;
import com.ko.twitter.vplay.core.internal.http.HttpResponse;
import com.ko.twitter.vplay.core.internal.http.HttpResponseEvent;
import com.ko.twitter.vplay.core.internal.http.HttpResponseListener;
import com.ko.twitter.vplay.core.internal.http.XAuthAuthorization;
...
import com.ko.twitter.vplay.core.util.function.Consumer;
...
import static com.ko.twitter.vplay.core.internal.http.HttpResponseCode.ENHANCE_YOUR_CLAIM;
import static com.ko.twitter.vplay.core.internal.http.HttpResponseCode.SERVICE_UNAVAILABLE;
import static com.ko.twitter.vplay.core.internal.http.HttpResponseCode.TOO_MANY_REQUESTS;
...
abstract class TwitterBaseImpl implements TwitterBase, java.io.Serializable, OAuthSupport, OAuth2Support, HttpResponseListener {
    ...
    final void ensureAuthorizationEnabled() {
        Log.e("TwitterException","ensureAuthorizationEnabled enters");
        if (!auth.isEnabled()) {
            Log.e("TwitterException","ensureAuthorizationEnabled IllegalStateException Authentication credentials are missing");
            throw new IllegalStateException(
